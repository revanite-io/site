...
const cyanTheme: AppTheme = {
  ...
  colors: {
    ...
    textSubtle: "#a0d4d6",
    accent: "#3AD0E6",
    accentSoft: "rgba(58, 208, 230, 0.2)",
    borderStrong: "rgba(58, 208, 230, 0.3)",
    buttonText: "#000000"
  },
  radii: {
    lg: "0.75rem",
  ...
  shadows: {
    surface:
      "0 8px 32px rgba(0, 0, 0, 0.8), 0 0 0 1px rgba(58, 208, 230, 0.2)",
    surfaceStrong:
      "0 12px 48px rgba(0, 0, 0, 0.9), 0 0 20px rgba(58, 208, 230, 0.4)"
  },
  spacing: {
    md: "1.25rem",
    lg: "2rem",
...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({ children }) => {
  ...
  const cssVariables: React.CSSProperties = {
    ...
    "--gf-cyan-glow": "rgba(58, 208, 230, 0.4)",
